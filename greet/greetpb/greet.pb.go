...
var file_greet_greetpb_greet_proto_rawDesc = []byte{
	...
	0x65, 0x65, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x41, 0x0a,
	0x10, 0x4c, 0x6f, 0x6e, 0x67, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x47, 0x72, 0x65, 0x65,
...
var file_greet_greetpb_greet_proto_depIdxs = []int32{
	...
	1, // 3: greet.GreetService.LongRequestGreet:input_type -> greet.GreetRequest
	3, // 4: greet.GreetService.GreetEveryone:input_type -> greet.GreetEveryoneRequest
	2, // 5: greet.GreetService.Greet:output_type -> greet.GreetResponse
	2, // 6: greet.GreetService.LongRequestGreet:output_type -> greet.GreetResponse
	4, // 7: greet.GreetService.GreetEveryone:output_type -> greet.GreetEveryoneResponse
